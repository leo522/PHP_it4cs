<?php
	echo "<div id = \"div_ExaminationResult\">
			<div id = \"div_ExaminationTitle\"><h2 title = \"測3-4種距離的力竭時間。\">有氧/無氧代謝能力測定:田徑場法</h2></div>
				...
				<table border = \"1\">
					...
					for($i = 0; $i < 4; $i++)
					{
						...
						echo "<tr>
								...
								<td><input id = \"input_".$distance."PercentSpeed\" type = \"text\" disabled = \"disabled\"/></td>
							</tr>";
					}
					echo "	<tr>
			...
			echo "</table>
				...
				<div id = \"div_HeartInfo\">
					...
					<table id = \"table_HeartInfo\" border = \"1\">
						...
						<tr>
							<td title = \"若配帶心率錶,運動當時心率值。\">臨界速度之穩定心率(bpm)</td>
			...
			<div id = \"div_PrescriptionTitle\"><h2 title = \"單趟訓練時間:休息時間 = 2:1~1:4。速度須高於臨界速度。每趟訓練時間須盡量接近預估值。訓練量為約略值。\">速耐力間歇跑訓練處方/訓練量評估: 田徑場法</h2></div>
			...
			<div id = \"div_PrescriptionMode\">
				<div id = \"div_Mode\">
					訓練模式：
					<select id = \"select_TR_Mode\" onchange = \"TrackPrescriptionTable(this.value, select_TR_Sets.value)\">
					...
					訓練變項：
					<select id = \"select_TR_Factor\" onchange = \"TrackPrescriptionTable(select_TR_Mode.value, select_TR_Sets.value)\" disabled = \"disabled\">
				...
				<div id = \"div_SetNum\">
					訓練組數：
					<select id = \"select_TR_Sets\" onchange = \"TrackPrescriptionTable(select_TR_Mode.value, this.value)\">
				...
				<button type = \"button\" onclick = \"TrackDefaultAttribute()\">預設訓練參數</button>
				訓練量合計：
				<input id = \"input_TR_TotT\" type = \"text\" disabled = \"disabled\">
			</div>
