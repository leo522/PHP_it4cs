<?php
	...
	{
		echo "<h3>第".$i."組</h>
			</br>單趟最佳訓練時間(s)：<input id = \"input_SS_BestTime_S".$i."\" size = \"5\" type = \"text\" value = \"0\" disabled = \"disabled\"/>
			<table border = \"1\" style=\"text-align:left\">
				<tr>
					<th id = \"th_SS_TurnNum".$i."\">趟數</th>
					<th><input id = \"input_SS_TNum_S".$i."\" size = \"5\" type = \"text\" value = \"0\" onkeyup = \"SwimSprintCaculatPrescription(".$i.", this.value, 3)\"/></th>
					<th>趟間休息時間(s)</th>
				...
				<tr>
					...
					<th><input id = \"input_SS_TTime2_S".$i."\" size = \"5\" type = \"text\" value = \"0\" onkeyup = \"SwimSprintCaculatPrescription(".$i.", this.value, 1)\"/> ： <input id = \"input_SS_RTime_S".$i."\" size = \"5\" type = \"text\" value = \"0\" onkeyup = \"SwimSprintCaculatPrescription(".$i.", this.value, 2)\"/></th>
					<th>訓練時間(s)</th>
